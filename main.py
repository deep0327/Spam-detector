...
def sms():
    ...
    if lab[a]=='spam':
        ...
        classification = Label(root, text=res, font=('helvetica', 15 , 'bold'), fg="orange")
        classification.pack()
    else:
...
head = Label(root, text='SPAM  DETECTOR',font=('helvetica', 24 , 'bold'))
head.pack()
e = Entry(root, width=400,borderwidth=5)
e.pack()
b = Button(root, text = 'DETECT', font=('helvetica', 20 , 'bold'), fg = 'yellow', bg = 'green', command = sms)
b.pack()
root.mainloop()
